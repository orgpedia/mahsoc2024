# Orders of deparment of Social Justice and Special Assistance Department Government of Maharashtra
...
1. [mahsoc2024-*.pdf.en.txt](flow/writeTxt_/output/): Orders in Marathi.

2. [mahsoc2024-*.pdf.mr.txt](flow/writeTxt_/output/): Orders in English.
...
```
git clone https://github.com/orgpedia/mahsoc2024.git
```
